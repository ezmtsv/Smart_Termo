...
/*	
		if(Data != 0xe4bd && Data != 0xc000 && Data != 0xe4bc && Data != 0x1000 && Data != 0x0000){
			Send_Buffer[27] = 0x23;
			Send_Buffer[28] = 0x45;
			spi_com_bag++;	
				
			Send_Buffer[32] =0x99;
			Send_Buffer[33] = (uint8_t)spi_com_bag; 			
			Send_Buffer[34+bag_step] = (uint8_t)Data;
			Send_Buffer[35+bag_step] = (uint8_t)(Data>>8);
			Send_Buffer[36+bag_step] = 0x98;
			bag_step+=3;
		}
*/	
}
